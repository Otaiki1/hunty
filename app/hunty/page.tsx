                ...
                {activeTab === "create" && (
                  <div className="space-y-6">
                    ...
                    <div className="flex justify-end">
                      <Button
                        className="bg-slate-800 hover:bg-slate-700 text-white text-xl font-extrabold px-6 py-4 rounded-xl flex items-center gap-2 cursor-pointer"
                      ...
                      <div className="flex items-center gap-2">
                        <div className="relative">
                          <div className="p-0.5 bg-gradient-to-b from-[#2D4FEB] to-[#0C0C4F] rounded-lg">
                            <Input type="number" min="0" max="59" placeholder="00" className="w-full text-center text-lg font-medium bg-white rounded-lg px-3 py-2 border-0" />
                          </div>
                        </div>
